...
public class BillCounter {
	...
	public static double getNetPayableAmount(Transaction transaction) {
		...
		if(CustomerType.COMMON.equals(customerType) && (BillCounter.isRegistrationDateOverTwoYears(transaction.getCustomerDetails().getDateOfRegistration()))) {
	...
	/**
	 * isRegistrationDateOverTwoYears - This method checks if user is registered to store before 2 years
